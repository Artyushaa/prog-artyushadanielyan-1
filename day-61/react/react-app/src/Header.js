    ...
    return (
        <>
             <div className={classname}>
                ...
                <DropDownText dropDownText='Shop – Filter' />
...
export function DropDownText({ dropDownText }) {
    return (
        <>
            <a className="departament__list__drop-down-text" href="#">{dropDownText}</a>
        </>
    )
}
                    ...
                    <div className="profile">
                        <div className="profile__action">
                            <a href="#" className="profile__link">
                                ...
                                <a href="#" className="profile__link">Compare</a>
                            </a>
                        </div>
                        ...
                        <div className="profile__action">
                            <a href="#" className="profile__link">
                                ...
                                <a href="#" className="profile__link">Cart</a>
                            </a>
                        </div>
